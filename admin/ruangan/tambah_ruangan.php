...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($kode_ruangan) || empty($nama_ruangan) || empty($kapasitas) || empty($lokasi)) {
        ...
        // Cek apakah kode_ruangan atau nama_ruangan sudah ada di database
        $check_query = "SELECT * FROM ruangan WHERE kode_ruangan = '$kode_ruangan' OR nama_ruangan = '$nama_ruangan'";
...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="tambah_ruangan.php" method="POST"  class="card p-4 shadow-sm">
            <div class="mb-3">
