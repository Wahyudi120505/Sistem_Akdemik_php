...
// Ambil semua jadwal kuliah yang diampu oleh dosen yang sedang login
            ...
            <div class="table-responsive">
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        // Menambahkan ID mata kuliah pada URL
                        $url_daftar_hadir = "daftar_hadir.php?id={$row['id']}";

                        echo "<tr onclick='window.location.href=\"{$url_daftar_hadir}\"'>";
                        echo "<td>{$no}</td>";
